## General methods for list 3 of exercises

This is a collection of general methods used in the exercises of list 3 of the "Fundamentals of the Java Programming Language" module. These methods are intended to provide a more robust and comprehensive learning experience, with added input validation, error handling, and personalized messages.
...
Get back to the [list 3](Readme.md) of exercises for the "Fundamentals of the Java Programming Language" module.
